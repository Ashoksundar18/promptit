            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 rounded-xl bg-bg-tertiary border border-glass-border focus:border-accent-blue  outline-none text-text-primary text-sm transition-all"
                  placeholder="••••••••"
                  required
                />
                <button

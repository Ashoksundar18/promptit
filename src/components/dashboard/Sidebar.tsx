        ...
        {showLogoutModal && (
          ...
          >
            <motion.div
              ...
              className="glass rounded-2xl border border-glass-border p-6 max-w-sm w-full mx-4 shadow-2xl"
            ...
            >
              ...
              <p className="text-sm text-text-secondary mb-6">
                Are you sure you want to logout? You will need to sign in again to access your prompts.
              </p>

              <div className="flex gap-3">
                <motion.button
                  onClick={() => setShowLogoutModal(false)}
                  className="flex-1 py-2.5 rounded-xl glass text-sm font-medium text-text-secondary hover:text-text-primary hover:bg-glass-bg-hover transition-all cursor-pointer"
                ...
                <motion.button
                  ...
                  className="flex-1 py-2.5 rounded-xl bg-accent-pink/15 border border-accent-pink/30 text-sm font-medium text-accent-pink hover:bg-accent-pink/25 transition-all cursor-pointer"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
                  Yes, Logout
